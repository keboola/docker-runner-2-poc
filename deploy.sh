...
docker tag keboola/docker-runner-2-poc:latest 061240556736.dkr.ecr.eu-central-1.amazonaws.com/keboola/docker-runner-2-poc:$TRAVIS_TAG
...
docker push 061240556736.dkr.ecr.eu-central-1.amazonaws.com/keboola/docker-runner-2-poc:$TRAVIS_TAG
